...
contract TokenAvgPrice is Initializable, PausableUpgradeable, OwnableUpgradeable {
    ...
    function setDailyPrice(address token, uint256 day, uint256 price) external whenNotPaused {
